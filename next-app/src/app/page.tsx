...
const Home = () => {
  ...
  return (
    ...
    <main>
      ...
      <input type="email" className="w-full py-2 px-2 form-control w10 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="name@example.com"></input>
      <button
        type="button"
