  ...
  return (
    <form className='mt-4 mb-4' onSubmit={handleSubmit}>
      <input 
        ...
        value={text}
        onChange={changeText}  
        className='w-full py-2 px-2 border-gray-200 form-control w10 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"'
      />
      <button 
        type="submit" 
